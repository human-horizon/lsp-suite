...
void extract_symbols(TSNode node, TSLanguage *lang) {
    ...
    if (strcmp(name, "class_definition") == 0 ||
        strcmp(name, "object_definition") == 0 ||
        strcmp(name, "trait_definition") == 0 ||
        strcmp(name, "definition") == 0 ||
        strcmp(name, "val_definition") == 0) {
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"scala-lsp\",\"version\":\"0.1.0\"}}";
            ...
            if (!source) {
                ...
                TSLanguage *lang = tree_sitter_scala();
                extract_symbols(root, lang);
            ...
            send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"Scala symbol\"}}");
