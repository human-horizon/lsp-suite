/**
 * cpp-lsp-tree - C++ Language Server using tree-sitter
 */
...
void extract_symbols(TSNode node) {
    ...
    if (strcmp(name, "function_definition") == 0 ||
        strcmp(name, "class_specifier") == 0 ||
        strcmp(name, "struct_specifier") == 0 ||
        strcmp(name, "enum_specifier") == 0 ||
        strcmp(name, "namespace_definition") == 0) {
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"cpp-lsp-tree\",\"version\":\"0.1.0\"}}";
