/**
 * js-lsp - JavaScript Language Server
...
void extract_symbols_tree(TSNode node) {
    ...
    if (strcmp(name, "function_declaration") == 0 ||
        ...
        strcmp(name, "variable_declaration") == 0 ||
        strcmp(name, "arrow_function") == 0) {
...
int main(int argc, char** argv) {
    ...
    ts_parser_set_language(tree_parser, tree_sitter_javascript());
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true,\"definitionProvider\":true}},\"serverInfo\":{\"name\":\"js-lsp\",\"version\":\"0.1.0\"}}";
            ...
            if (!source) {
                ...
                if (use_oxc) {
                    ...
                    current_symbols = oxc_parse_js(source);
            ...
            if (use_oxc && current_symbols.count > 0) {
                ...
                send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"JavaScript symbol\"}}");
            }
