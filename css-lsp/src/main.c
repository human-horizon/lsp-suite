/**
 * css-lsp - CSS Language Server using tree-sitter
 */
...
void extract_symbols(TSNode node, const TSLanguage *lang) {
    ...
    if (strcmp(name, "rule_set") == 0 ||
        strcmp(name, "declaration") == 0 ||
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"css-lsp\",\"version\":\"0.1.0\"}}";
            ...
            if (!source) {
                ...
                extract_symbols(root, tree_sitter_css());
            ...
            send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"CSS Property\"}}");
