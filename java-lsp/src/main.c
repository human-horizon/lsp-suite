/**
 * java-lsp - Java Language Server using tree-sitter
 */
...
void extract_symbols(TSNode node, const TSLanguage *lang) {
    ...
    if (strcmp(name, "class_declaration") == 0 ||
        strcmp(name, "method_declaration") == 0 ||
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"java-lsp\",\"version\":\"0.1.0\"}}";
            ...
            if (!source) {
                ...
                extract_symbols(root, tree_sitter_java());
            ...
            send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"Java symbol\"}}");
