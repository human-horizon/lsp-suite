/**
 * go-lsp - Go Language Server using tree-sitter
 */
...
void extract_symbols(TSNode node, const TSLanguage *lang) {
    ...
    if (strcmp(name, "function_declaration") == 0 ||
        strcmp(name, "type_declaration") == 0 ||
        strcmp(name, "const_declaration") == 0 ||
        strcmp(name, "var_declaration") == 0) {
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"go-lsp\",\"version\":\"0.1.0\"}}";
            ...
            if (!source) {
                ...
                extract_symbols(root, tree_sitter_go());
            ...
            send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"Go symbol\"}}");
