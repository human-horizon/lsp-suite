...
void extract_symbols(TSNode node, const TSLanguage *lang) {
    ...
    if (strcmp(name, "element") == 0 ||
        strcmp(name, "script_element") == 0 ||
        strcmp(name, "style_element") == 0 ||
        strcmp(name, "heading") == 0 ||
        strcmp(name, "paragraph") == 0) {
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"html-lsp\",\"version\":\"0.1.0\"}}";
            ...
            if (!source) {
                ...
                extract_symbols(root, tree_sitter_html());
            ...
            send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"HTML Element\"}}");
