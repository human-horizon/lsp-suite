/**
 * ruby-lsp - Ruby Language Server using tree-sitter
 */
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"ruby-lsp\",\"version\":\"0.1.0\"}}";
            ...
            if (!source) {
                ...
                extract_symbols(root, tree_sitter_ruby());
            ...
            send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"Ruby symbol\"}}");
