/**
 * php-lsp - PHP Language Server using tree-sitter
 */
...
void extract_symbols(TSNode node, const TSLanguage *lang) {
    ...
    if (strcmp(name, "function_definition") == 0 ||
        ...
        strcmp(name, "trait_declaration") == 0 ||
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(method, "initialize") == 0) {
            const char *result = "{\"capabilities\":{\"textDocument\":{\"documentSymbol\":{\"hierarchicalDocumentSymbolSupport\":true},\"hoverProvider\":true}},\"serverInfo\":{\"name\":\"php-lsp\",\"version\":\"0.1.0\"}}";
            ...
            send_response(id, "{\"contents\":{\"kind\":\"markdown\",\"value\":\"PHP symbol\"}}");
